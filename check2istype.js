...
"Undefined","Null","Boolean","String","Number","Global","Date","Error","Function","Array","Object","Regexp"
...
function kindOf(x){
	...
	return rawObj({type:o(s),isPrimitive:o({toString:function(){return String(p)},valueOf:function(){return p},wrapped:p&&(x!=null&&typeof(x)==='object')?true:false})});
};
//
(function(e,m){
	e=e.isType=rawObj();
	var s,i=0;
	while(s=m[i++]){e[LowercaseExceptFirst(s)]=Function('x','return kindOf(x).type==="'+s+'"')};
	Object.freeze(e);
})(ScopeRoot,['global','undefined','null','boolean','string','number','date','error','function','array','object','regexp']);
//




console.log(isType.Number(3))
